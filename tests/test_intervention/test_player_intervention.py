...
class TestPlayerIntervention:
    ...
    async def test_process_ooc_intervention(self):
        ...
        result = await self.intervention._process_single_intervention(
    ...
    async def test_process_interventions_list(self):
        ...
        session_context = {"session_id": "test_session"}
        results = await self.intervention.process_interventions(
            interventions, session_context
        )
    ...
    def test_merge_interventions_into_prompt(self):
        ...
        prompt = self.intervention.merge_interventions_into_prompt(
            clean_input, intervention_results
        )
    ...
    def test_audit_intervention(self):
        ...
        audit = asyncio.run(
            self.intervention.audit_intervention(intervention, result, "test_user")
        )
    ...
    async def test_process_player_input_with_integration(self):
        ...
        result = await self.intervention.process_player_input_with_integration(
            text, mock_session_manager, "test_session", mock_turn_scheduler, "test_turn"
        )
