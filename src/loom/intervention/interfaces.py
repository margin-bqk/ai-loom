...
class AuditLogger(ABC):
    ...
    @abstractmethod
    async def log_intervention(self, intervention: Intervention, result: ProcessedResult) -> None:
        """记录干预
    ...
    @abstractmethod
    async def get_intervention_history(self, session_id: str, limit: int = 100) -> List[Dict[str, Any]]:
        """获取干预历史
