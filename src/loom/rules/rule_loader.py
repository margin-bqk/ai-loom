...
class RuleLoader:
    ...
    def __init__(self, canon_dir: str = "./canon", recursive: bool = True):
        ...
        logger.info(f"RuleLoader initialized with canon_dir={canon_dir}, recursive={recursive}")
    ...
    def load_canon(self, canon_name: str = "default") -> Optional[MarkdownCanon]:
        ...
        try:
            ...
            if cache_key in self.canon_cache and self.file_hashes.get(cache_key) == current_hash:
